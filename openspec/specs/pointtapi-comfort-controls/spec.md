...
Exposes the writable comfort settings the Bosch app offers but the integration did not: away mode, extra hot water with its duration, and the thermal-disinfect schedule. All follow the established PUT-and-refresh pattern and disappear when the device does not advertise the underlying resource.
