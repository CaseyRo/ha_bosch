...
Surface the gas burner's flame-on indicator and lifetime ignition-start count as Home Assistant entities, attached to the Boiler device. Lets users see whether the burner is firing right now and track wear via the long-term-statistics view.
